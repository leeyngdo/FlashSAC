...
This package vendors the BeyondMimic tracking stack (from ``whole_body_tracking``)
into FlashSAC and keeps the task split into per-robot registrations, modular
observations, reward and termination registries, and a multi-dataset motion loader
